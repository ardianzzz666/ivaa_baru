$(document).ready(function(){
  ...
  $('a.delete-artwork-ajax').click(function(){
	 ...
	 $.ajax({
	    	url: SERVER+'admin/ArtworksEvents/delete',
	    	type: 'POST',
	    	dataType: 'html',
	    	data: {id:id},
	    	success:
  ...
  $('#add-artwork-ajax').click(function(){
	 ...
	 $.ajax({
	    	url: SERVER+'admin/ArtworksEvents/add',
	    	type: 'POST',
	    	dataType: 'html',
	    	data: 
	    		$('#ArtworksEventForm').serialize(),
	    	success:
	    	    function(response){
	    	    	//alert('response');
			$( "#artwork" ).val("");
