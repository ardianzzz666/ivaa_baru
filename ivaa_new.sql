...
--
-- Host: localhost:3306
-- Generation Time: Feb 04, 2020 at 07:29 PM
...
INSERT INTO `artists` (`id`, `user_id`, `fullname`, `nickname`, `birth_country`, `birth_city`, `birth_date`, `birth_month`, `birth_year`, `not_alive`, `living_address`, `living_city`, `living_country`, `domicile`, `email`, `phone`, `website`, `created`, `modified`, `is_registered`, `slug`, `description`, `obit`, `description_en`) VALUES
(1, 1, 'Testing Artis', 'Artis', 1, 1, '2020-01-23', '1', '1996', 0, 'asasasa sasasas asasas', 1, 1, 1, 'ardian@gmail.com', '082220494229', 'www.asas.com', '2020-01-23 06:47:09', '2020-01-23 06:47:09', 1, 'yasas-asas', 'asd adasdas asd asd asd sad ', 'asdasdsad', 'asdasd aasda d aasd asasdsad  saad ');
...
CREATE TABLE `artists_collectives` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `artists_industries` (
  `id` int(11) NOT NULL,
  `artist_id` int(11) NOT NULL,
...
CREATE TABLE `artworks_creators` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `artworks_khazanahs` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `khazanahs_participants` (
  `id` int(11) NOT NULL,
  `khazanah_id` int(11) NOT NULL,
...
CREATE TABLE `khazanah_categories` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `name_en` varchar(155) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
