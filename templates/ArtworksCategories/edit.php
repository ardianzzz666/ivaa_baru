...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $artworksCategory->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $artworksCategory->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="artworksCategories form content">
            ...
            <fieldset>
                <legend><?= __('Edit Artworks Category') ?></legend>
                <?php
